			...
			<div id="content">
                ...
                <div class="tab-menu">
					<ul>
                        ...
                        <li><a href="site0602_view02.jsp" class="on">신청자</a></li>
							...
							<tbody>
								<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#n" onclick="window.open('site0602_view02_popup.jsp','','width=800, height=750, scrollbars=yes');return false;"><strong class="f-color-blue">[수정]</strong></a>
                ...
                <div id="regist">
					...
					<a href="#n" class="btn-large-red btn-write" onclick="window.open('site0602_view02_popup.jsp','','width=800, height=750, scrollbars=yes');return false;">신청자 강제 등록</a>
                </div>
                <!-- // 페이징 -->
