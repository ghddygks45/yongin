...
<title>상시교육 전체 &gt; 상시교육 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(2);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
				...
				<span>상시교육</span>
				<strong>상시교육 전체</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>상시교육 전체</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="top-info">
                        <div class="top-info-txt bg-info-per02">
                            <p>용인시 평생학습관이 제공하는 상시교육 프로그램 신청목록을 조회하시고 용인시 통합 로그인 후 교육에 참여하실 수 있습니다.</p>
                            <ul class="list01">
                                <li>상시교육은 용인시 평생학습관의 수시교육, 평생교육(하루특강, 단기특강)과 관내(구별) 평생학습관에서 운영하는 교육으로 구성됩니다.</li>
                                <li><strong class="ft400">본 화면을 통해 용인시와 구별 평생학습관이 운영하는 교육을 통합조회하시고 교육신청하실 수 있습니다.</strong></li>
                            </ul>
                        </div>
                    </div>
                    <div class="tab-mn m-tab2">
                        <ul>
                            ...
                            <li><a href="#n"><span>수시교육</span></a></li>
                            <li><a href="#n"><span>평생교육(하루특강)</span></a></li>
                            <li><a href="#n"><span>평생교육(단기특강)</span></a></li>
                            <li><a href="#n"><span>기흥구 평생학습관 교육</span></a></li>
                            <li><a href="#n"><span>수지구 평생학습관 교육</span></a></li>
                            <li><a href="#n"><span>처인구 평생학습관 교육</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="list-board two-sec li3-bk" data-edu-board="edu-board">
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="perman_edu02_view.jsp" class="line-through">
                                        <strong>
                                            한식조리기능사 (오전) 
                                        </strong>
                                    </a>
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="perman_edu02_write.jsp" class="btn-edu bg-blue">수강신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="perman_edu02_write.jsp" class="btn-edu bg-lime">추가모집신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
