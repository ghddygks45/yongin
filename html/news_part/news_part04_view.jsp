...
<title>상세내용 &gt; 질문과 답변 &gt; 소식참여 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(4);
		...
		<div id="content">
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="news_part04.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
                            <a href="news_part04_write.jsp" class="btn default sz-free bg-lime">수정</a>
