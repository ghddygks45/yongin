			...
			<div id="content">
                ...
                <div class="tab-menu">
					<ul>
                        ...
                        <li><a href="site0503_view03.jsp" class="on">합격자</a></li>
							...
							<tbody>
								<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#n" onclick="window.open('site0503_view03_popup.jsp','','width=800, height=800, scrollbars=yes');return false;"><strong class="f-color-blue">[수정]</strong></a>
                ...
                <div id="regist">
					...
					<a href="#n" class="btn-large-red btn-write" onclick="window.open('site0503_view03_popup.jsp','','width=800, height=800, scrollbars=yes');return false;">합격자 강제 등록</a>
                </div>
                <!-- // 페이징 -->
