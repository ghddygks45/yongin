...
<title>다온터 전시실 사용신청 내역 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(9);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>마이페이지</span>
				<strong>다온터 전시실 사용신청 내역</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>다온터 전시실 사용신청 내역</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="layer-popup-box" data-popup="edu-popup1">
                        <div class="popup pop-size-700" tabindex="0">
                            <div class="top">
                                <h4>다온터 전시실 사용신청정보</h4>
                            </div>
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-edu-pop">
                                        <p><strong class="edu-str color-black-222">다온터 전시실 사용신청이 완료되었습니다.</strong></p>
                                        <p>
                                ...
                                <div class="board-write th-size-default">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="div-td txt-td"><strong class="ft400">2020. 08. 03(월요일) ~  2020. 08. 07(금요일)</strong></div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="layer-popup-box" data-popup="edu-popup2">
                        <div class="popup pop-size-700" tabindex="0">
                            <div class="top">
                                <h4>다온터 전시실 사용 승인정보</h4>
                            </div>
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-edu-pop">
                                        <p><strong class="edu-str color-black-222">다온터 전시실 사용승인이 완료되었습니다.</strong></p>
                                        <p>
                                            전시실 사용승인 후 변경은 불가능합니다. 전시실 사용 여부가 변경되는 경우 담당자에게 문의 해주세요(031-000-0000)
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="btn-pg-line">
                        <a href="../news_part/news_part06_write.jsp" class="btn default sz-free bg-blue">다온터 전시실 사용신청</a>
                    </div>
