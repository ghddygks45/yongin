...
<title>상세내용 &gt; 수시교육 &gt; 상시교육 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(3);
		...
		<div id="content">
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="perman_edu03.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
                            <a href="perman_edu03_write.jsp" class="btn default sz-fix1 bg-blue">수강신청</a>
                            <a href="perman_edu03_write.jsp" class="btn default sz-fix1 bg-lime">추가모집신청</a>
                        </div>
                    </div>
