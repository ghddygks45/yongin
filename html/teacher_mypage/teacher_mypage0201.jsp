				...
				<div class="cnt">
                    ...
                    <div class="list-board two-sec li2-bk mypg-my-edu" data-edu-board="edu-board">
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="teach_mypage0201_view.jsp">
                                        <strong>
                            ...
                            <div class="r">
                                <div class="r-btn-box">
                                    <a href="teach_mypage0201_clock.jsp" class="btn-edu bg-lime">강사 출근부</a>
                                    <a href="teach_mypage0201_app.jsp" class="btn-edu bg-blue">출석부 관리</a>
