...
<title>정기교육 &gt; 정기교육 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(2);
				...
				<div class="cnt">
                    ...
                    <div class="list-board two-sec li2-bk" data-edu-board="edu-board">
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="regular_edu02_view.jsp" class="line-through">
                                        <strong>
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="regular_edu02_write.jsp" class="btn-edu bg-blue">수강신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="regular_edu02_write.jsp" class="btn-edu bg-lime">추가모집신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
