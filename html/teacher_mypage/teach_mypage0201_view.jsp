...
<title>상세내용 &gt; 나의 강좌관리 &gt; 정기교육 관리 &gt; 강사전용 페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(2, 1);
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="tab-mn auto m-tab2">
                        <ul>
                            <li><a href="teacher_mypage0201.jsp" class="on"><span>정기교육</span></a></li>
                            <li><a href="teacher_mypage0202.jsp"><span>상시교육</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="board-write th-size-default">
                            ...
                            <div class="row">
                                <div class="div-th">신청자/정원</div>
                                <div class="div-td">50명/25명</div>
                            </div>
                            <div class="row">
                                <div class="div-th">신청/대기인원</div>
                                <div class="div-td">50명/25명</div>
                            </div>
                            <div class="row">
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="teacher_mypage0201.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
                            <a href="teach_mypage0201_clock.jsp" class="btn default sz-free bg-lime">강사 출근부</a>
                            <a href="teach_mypage0201_app.jsp" class="btn default sz-free bg-blue">출석부 관리</a>
                        </div>
                    </div>
