...
<title>수강료 면제자 증명 &gt; 정기교육 강좌관리 &gt; 나의 강좌관리 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(1, 1);
                            ...
                            <div class="pop-content" tabindex="0">
                                ...
                                <div class="board-write pop-edu-th">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="div-td txt-td">43기</div>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="popup pop-size-700" tabindex="0">
                            ...
                            <div class="pop-content">
                                ...
                                <div class="board-write th-size-default">
                                    ...
                                    <div class="row">
                                        <div class="div-th">과정</div>
                                        <div class="div-td">직업능력</div>
                                    </div>
                                    <div class="row">
