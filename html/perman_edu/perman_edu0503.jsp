...
<title>처인구 교육프로그램 &gt; 구별 교육프로그램 &gt; 상시교육 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(5, 3);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>상시교육</span>
                <span>구별 교육프로그램</span>
				<strong>처인구 교육프로그램</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>처인구 교육프로그램</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="top-info">
                        <div class="top-info-txt bg-info-per053">
                            <p>용인시 구별 평생학습관이 제공하는 교육 프로그램 신청목록을 조회하시고 용인시 통합 로그인 후 교육에 참여하실 수 있습니다.</p>
                            <ul class="list01">
                                <li>처인구 교육은 용인시 처인구 평생학습관에서 운영하는 교육으로 구성됩니다.</li>
                                <li><strong class="ft400">본 화면을 통해 용인시 처인구 평생학습관에서 운영하는 교육을 조회하시고 교육신청 하실 수 있습니다.</strong></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="list-board two-sec li3-bk" data-edu-board="edu-board">
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="perman_edu0503_view.jsp" class="line-through">
                                        <strong>
                                            한식조리기능사 (오전) 
                                        </strong>
                                    </a>
                        ...
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="perman_edu0503_view.jsp">
                                        <strong>
                                            한식조리기능사 (오전) 
                                        </strong>
                                    </a>
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="perman_edu0503_write.jsp" class="btn-edu bg-blue">수강신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="perman_edu0503_write.jsp" class="btn-edu bg-lime">추가모집신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
