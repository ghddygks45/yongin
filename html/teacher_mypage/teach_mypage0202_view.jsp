			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="btn-box">
                        ...
                        <div class="r">
                            <a href="teach_mypage0202_clock.jsp" class="btn default sz-free bg-lime">강사 출근부</a>
                            <a href="teach_mypage0202_app.jsp" class="btn default sz-free bg-blue">출석부 관리</a>
                        </div>
                    </div>
