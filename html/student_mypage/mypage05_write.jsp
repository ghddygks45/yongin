...
<title>글 등록 &gt; 평생교육사 신청현황 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(6);
		...
		<div id="content">
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                            ...
                            <div class="pop-content">
                                ...
                                <div class="mypg-edu-link">
                                    <div class="inr">
                                        ...
                                        <div class="bt">
                                            <a href="mypage05.jsp" class="btn small sz-free bg-lime">평생교육사 신청현황</a>
                                            <a href="mypage05.jsp" class="btn small sz-free bg-blue">확인</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="btn-box">
                        <div class="r">
                            <a href="#n" data-focus-btn="focus-btn" class="btn default sz-free bg-lime" onclick="layerPopupOpen('edu-popup');return false;">평생교육사 등록 신청내역 수정</a>
                        </div>
                    </div>
