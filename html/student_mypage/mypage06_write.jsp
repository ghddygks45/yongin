...
<title>글 등록 &gt; 강사은행제 강사 신청현황 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(7);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>마이페이지</span>
				<strong>강사은행제 강사 신청현황</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>강사은행제 강사 신청현황</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <!-- 강사은행제 강사 등록 신청내역 수정완료 팝업 -->
                    <div class="layer-popup-box" data-popup="edu-popup">
                        <div class="popup pop-size-700" tabindex="0">
                            <div class="top">
                                <h4>강사은행제 강사 등록 신청내역 수정완료</h4>
                            </div>
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-edu-pop">
                                        <p><strong class="edu-str color-black-222">강사은행제 강사 등록신청내역 수정이 완료되었습니다.</strong></p>
                                        <p>
                                            강사은행제 강사 등록신청내역 수정 후 용인시 평생학습관 <strong class="ft300 color-orange">담당자의 승인을 통해 홈페이지에 정보가 제공</strong>됩니다.
                                        </p>
                                    </div>
                                </div>
                                <div class="mypg-edu-link">
                                    <div class="inr">
                                        ...
                                        <div class="bt">
                                            <a href="mypage06.jsp" class="btn small sz-free bg-lime">강사은행제 강사 등록 신청현황</a>
                                            <a href="mypage06.jsp" class="btn small sz-free bg-blue">확인</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="btn-box">
                        <div class="r">
                            <a href="#n" data-focus-btn="focus-btn" class="btn default sz-free bg-lime" onclick="layerPopupOpen('edu-popup');return false;">강사은행제 강사 등록 신청내역 수정</a>
                        </div>
                    </div>
