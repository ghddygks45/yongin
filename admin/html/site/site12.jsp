		...
		<div id="middle">
			...
			<div id="content">
						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="common2">
							...
							<tbody>
								<tr>
                                    ...
                                    <td>2020-08-04</td>
                                    <td>
                                        <a href="site12_write.jsp" class="board-btn green">수정</a>
				...
				<div id="regist">
                    ...
                    <a href="site12_write.jsp" class="btn-large-red btn-write">평생교육사 등록</a>
				</div>
                <!-- // 페이징 -->
