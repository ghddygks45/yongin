...
<title>수시교육 &gt; 상시교육 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(3);
...
<main id="container">
	<div class="inner">
		...
		<div id="content">
			...
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>수시교육</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="top-info">
                        <div class="top-info-txt bg-info-per03">
                    ...
                    <div class="list-board two-sec li3-bk" data-edu-board="edu-board">
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="perman_edu03_view.jsp" class="line-through">
                                        <strong>
                                            한식조리기능사 (오전) 
                                        </strong>
                                    </a>
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="perman_edu03_write.jsp" class="btn-edu bg-blue">수강신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <a href="perman_edu03_write.jsp" class="btn-edu bg-lime">추가모집신청</a>
                            </div>
                        </div>
                        <div class="board-section">
                            <div class="fb">
