	...
	<div id="wrapper">
		...
		<div id="middle">
			...
			<div id="content">
				...
				<div class="tab-menu">
					<ul>
						<li><a href="site0301.jsp">진행중인 팝업창</a></li>
						<li><a href="site0302.jsp" class="on">마감된 팝업창</a></li>
					</ul>
				</div>
						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="common2">
							...
							<tbody>
								<tr>
									<td>1</td>
									<td>
										<a href="#n" onclick="window.open('site03_popup.jsp','','width=500, height=500, scrollbars=yes');return false;">2020년 평생학습관 정기교육 일정</a>
									</td>
									<td>2020-07-01~2020-07-31</td>
									<td><strong class="color-red">미표시</strong></td>
									<td>2020-06-31</td>
									<td>
										<a href="site0301_write.jsp" class="board-btn green">수정</a>
				...
				<div id="regist">
					...
					<a href="site0301_write.jsp" class="btn-large-red btn-write">팝업존 등록</a>
				</div>
				<!-- // 페이징 -->
