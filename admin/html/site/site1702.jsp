			...
			<div id="content">
                ...
                <div class="tab-menu">
					<ul>
                        ...
                        <li><a href="site1702.jsp" class="on">상시교육</a></li>
                        <li><a href="site1703.jsp">강사</a></li>
					</ul>
                </div>
