...
<title>평생교육사 등록 신청 &gt; 평생교육사 &gt; 휴먼 네트워크 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(2, 4);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>휴먼 네트워크</span>
                <span>평생교육사</span>
				<strong>평생교육사 등록 신청</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>평생교육사 등록 신청</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="section">
                        ...
                        <div class="agree-box">
                            <div class="ag-inner">
                                ...
                                <p class="mgt-s">본인은 "평생교육사“ 등록 신청서에 기재한 개인 신상정보를 기부활동처에 연결 등을 위하여 이에 원활한 활동을 위하여 타 기관에 개인정보를 제공하는데 동의합니다.</p>
                            ...
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-edu-pop">
                                        <p><strong class="edu-str color-black-222">평생교육사 등록신청이 완료되었습니다.</strong></p>
                                        <p>
                                            평생교육사 등록 신청 후 용인시 평생학습관 <strong class="ft300 color-orange">담당자의 승인을 통해 홈페이지에 정보가 제공</strong>됩니다.
                                        </p>
                                    </div>
                                </div>
                                <div class="mypg-edu-link">
                                    <div class="inr">
                                        <div class="tt">
                                            승인진행과정은 [마이페이지 &gt; 평생교육사 신청현황]<span class="pc-block">에서 확인하실 수 있습니다.</span>
                                        </div>
                                        <div class="bt">
                                            <a href="../student_mypage/mypage05.jsp" class="btn small sz-free bg-lime">평생교육사 신청현황</a>
                                            <a href="hmm_network0203.jsp" class="btn small sz-free bg-blue">확인</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="btn-box">
                        <div class="r">
                            <a href="#n" data-focus-btn="focus-btn" class="btn default sz-free bg-lime" onclick="layerPopupOpen('edu-popup');return false;">평생교육사 등록 신청</a>
                        </div>
                    </div>
