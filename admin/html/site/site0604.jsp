						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="common2">
							...
							<tbody>
								<tr>
                                    ...
                                    <td><a href="#n" class="board-btn red" onclick="window.open('site0604_popup01.jsp','','width=700, height=830, scrollbars=yes');return false;">환불처리</a></td>
                                    <td><a href="#n" class="board-btn gray" onclick="window.open('site0604_popup02.jsp','','width=700, height=600, scrollbars=yes');return false;">환불취소</a></td>
                                </tr>
                                <tr>
                                    <td>1</td>
                                    <td>수시교육</td>
                                    ...
                                    <td><strong class="f-color-blue">2020-06-21 09:00</strong></td>
                                    <td><strong class="f-color-red">2020-06-22 09:00</strong></td>
                                    <td><a href="#n" class="board-btn blue" onclick="window.open('site0604_popup03.jsp','','width=700, height=930, scrollbars=yes');return false;">환불내역</a></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>1</td>
