...
<body>
	<div id="wrapper">
		...
		<div id="middle">
			...
			<div id="content">
				<div id="contentTitle">
					<div id="title">초기화면 팝업존 영역 관리</div>
					<div id="location">
						<img src="/yongin/admin/images/cms/home_icon.png" alt="home" />
						<span class="ent">&gt;</span>
						<span>사이트 관리</span>
						<span class="ent">&gt;</span>
						<span>초기화면 팝업존 영역 관리</span>
					</div>
				</div>

				<div class="tab-menu">
					<ul>
						<li><a href="site0201.jsp">진행중인 팝업존</a></li>
						<li><a href="site0202.jsp" class="on">마감된 팝업존</a></li>
					</ul>
				</div>
							...
							<tbody>
								<tr>
									...
									<td class="txt-left">
										스포츠센터 일부 개장
										<span class="pc-m-pop">
											<a href="#n" onclick="window.open('site02_pc_popup.jsp','','width=450, height=350, scrollbars=yes');return false;">[PC]</a>
											<a href="#n" onclick="window.open('site02_m_popup.jsp','','width=400, height=300, scrollbars=yes');return false;">[Mobile]</a>
										</span>
									</td>
									...
									<td>2020-06-31</td>
									<td>
										<a href="site0201_write.jsp" class="board-btn green">수정</a>
				...
				<div id="regist">
					...
					<a href="site0201_write.jsp" class="btn-large-red btn-write">팝업존 등록</a>
				</div>
				<!-- // 페이징 -->
