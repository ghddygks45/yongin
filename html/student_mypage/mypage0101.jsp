...
<title>정기교육 강좌관리 &gt; 나의 강좌관리 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(1, 1);
				...
				<div class="cnt">
                    ...
                    <div class="top-info">
                        <div class="top-info-txt bg-info-mypg0101">
                            <p>개인별로 용인시 평생학습관을 통해 신청하신 정기교육 프로그램에 대한 교육관리기능을 제공합니다.</p>
                            <p>
                    ...
                    <div class="list-board two-sec li2-bk mypg-my-edu" data-edu-board="edu-board">
                        <div class="board-section">
                            ...
                            <div class="r">
                                <div class="mypg-edu-con"><em class="color-light-blue">수강신청 완료</em></div>
                                <div class="r-btn-box">
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <div class="r-btn-box">
                                    ...
                                    <a href="#n" class="btn-edu bg-gray" data-focus-btn="focus-btn" onclick="layerPopupOpen('edu-popup4');return false;">신청내역 삭제</a>
                                </div>
                            </div>
                        </div>
                        <div class="board-section">
                        ...
                        <div class="board-section">
                            ...
                            <div class="l">
                                <div class="tp">
                                    <a href="mypage0101_view.jsp" class="line-through">
                                        <strong>
                                            <span class="board-cate">[조리]</span>
                                            한식조리기능사 (오전) 
                                        </strong>
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                ...
                                <div class="r-btn-box">
                                    <a href="mypage0101_edu_join.jsp" class="btn-edu bg-lime">교육참여현황</a>
                                    <a href="#n" class="btn-edu bg-light-wht" data-focus-btn="focus-btn" onclick="layerPopupOpen('edu-popup4');return false;">수강포기</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pop-content" tabindex="0">
                                <div class="top-info">
                                    <div class="top-info-txt bg-mypg-edu01">
                                        ...
                                        <p>
                                            <strong class="color-orange ft300">
                                                정기교육의 수강포기 시 다음기수 수강신청이 제한됩니다.<br>
                                                (※ 수시교육은 해당사항 없음)
                                            </strong>
                                        </p>
                                    </div>
