...
<title>다온터 전시실 사용신청 &gt; 심리상담 &gt; 소식참여 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(5);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>소식참여</span>
				<strong>다온터 전시실 사용신청</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>다온터 전시실 사용신청</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="top-info">
                        <div class="top-info-txt bg-info-news06">
                            <p>용인시 평생학습관 1층의 다온터 전시실을 평일 오전, 오후로 나누어 개방·공유하고 있습니다.</p>
                            <p>
                    ...
                    <div class="layer-popup-box" data-popup="complete-popup">
                        <div class="popup pop-size-700" tabindex="0">
                            <div class="top">
                                <h4>다온터 전시실 사용신청완료</h4>
                            </div>
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-pwd">
                                        <p><strong class="edu-str color-black-333">다온터 전시실 사용신청이 완료되었습니다.</strong></p>
                                        <p>예약 신청 후 용인시 평생학습관 운영담당자의 승인을 통해 확정되며 승인과정 중 사용일정이 협의될 수 있습니다.</p>
                                    </div>
                                </div>
                                <div class="board-write th-size-default">
                                    <div class="row">
                                ...
                                <div class="mypg-edu-link">
                                    <div class="inr">
                                        <div class="tt">동아리실 신청 및 승인진행과정은
                                            <span class="pc-block">[마이페이지 &gt; 다온터 전시실 사용신청 내역]</span>
                                            에서 확인하실 수 있습니다.
                                        </div>
                                        <div class="bt">
                                            <a href="#n" class="btn small sz-free bg-lime">다온터 전시실 사용신청 내역</a>
                    ...
                    <div class="btn-box">
                        ...
                        <div class="r">
                            <a href="#n" class="btn default sz-free bg-blue" data-focus-btn="focus-btn" onclick="layerPopupOpen('complete-popup');return false;">다온터 전시실 사용신청</a>
                        </div>
                    </div>
