...
<title>상세내용 &gt; 강사은행제 강사 신청현황 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(7);
		...
		<div id="content">
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="section">
                        ...
                        <div class="board-write th-size-default">
                            ...
                            <div class="row">
                                ...
                                <div class="div-td">선택된 분류 &gt; 입력된 세부분류</div>
                            </div>
                            <div class="row">
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="mypage06.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
                            <a href="mypage06_write.jsp" class="btn default sz-free bg-lime">강사은행제 강사 등록 신청내역 수정</a>
