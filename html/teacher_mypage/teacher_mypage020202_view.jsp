		...
		<div id="content">
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="teacher_mypage020202.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
                            <a href="teacher_mypage020202_write.jsp" class="btn default sz-free bg-lime">신청정보 수정</a>
