...
<title>공지사항 &gt; 소식참여 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(1);
...
<main id="container">
	<div class="inner">
		...
		<div id="content">
			...
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>공지사항</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                    ...
                    <div class="tab-mn m-tab2">
                        <ul>
                            ...
                            <li><a href="#n"><span>회관 및 시설이용</span></a></li>
                            <li><a href="#n"><span>교육</span></a></li>
                            <li><a href="#n"><span>상담/취업</span></a></li>
                            <li><a href="#n"><span>스포츠센터</span></a></li>
                    ...
                    <div class="list-board">
                        <div class="board-section">
                            <div class="fb bg-fb">
                                <span class="nb">주요</span>
                            </div>
                            <div class="l">
                                <div class="tp">
                                    <a href="news_part01_view.jsp">
                                        <strong>
