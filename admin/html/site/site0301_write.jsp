	...
	<div id="wrapper">
		...
		<div id="middle">
			...
			<div id="content">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="common1 mgb15">
						...
						<tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="mgr30">
                                        TOP : <input type="text" class="text" style="width:70px"> PX
                                    </span>
                                    <span>
                                        LEFT : <input type="text" class="text" style="width:70px"> PX
                                    </span>
                                </td>
                            </tr>
                            <tr>
								<th scope="row">팝업창 이미지(PC)</th>
								<td>
                                    <div class="att-file">
                ...
                <div class="btn_wrap">
					<div class="fl">
						<a href="site0301.jsp" class="btn-large-gray">목록</a>
					</div>
					<div class="fr">
                        <a href="#n" class="btn-large-red">팝업창 등록</a>
