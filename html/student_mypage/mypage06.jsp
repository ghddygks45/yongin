...
<title>강사은행제 강사 신청현황 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(7);
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                        ...
                        <div class="board-section">
                            ...
                            <div class="r">
                                <div class="c-wrap">
                                    ...
                                    <div class="r-btn-box">
                                        <a href="mypage06_view.jsp" class="btn-edu bg-light-gray size-free">상세정보</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="btn-pg-line">
                        <a href="mypage06_write.jsp" class="btn default sz-free bg-blue">강사은행제 강사 등록 신청</a>
                    </div>
