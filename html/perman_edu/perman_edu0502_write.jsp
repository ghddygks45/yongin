...
<title>수강신청 &gt; 수지구 교육프로그램 &gt; 구별 교육프로그램 &gt; 상시교육 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(5, 2);
                            ...
                            <div class="pop-content" tabindex="0">
                                <div class="top-info">
                                    <div class="top-info-txt bg-edu-pop">
                                        ...
                                        <p>
                                            상시교육은 선착순방식으로 교육참여가능여부가 선정됩니다.
                                            <span class="pc-block color-orange">상시교육신청 이후 3일 이내에 수강료 결제를 하셔야합니다.</span>
