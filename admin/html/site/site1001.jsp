		...
		<div id="middle">
			...
			<div id="content">
						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="common2">
							...
							<tbody>
								<tr>
                                    ...
                                    <td>회관 및 시설이용</td>
                                    <td class="txt-left"><a href="site1001_view.jsp">평생학습관 정기교육 제43기 폐강에 따른 기존 수강생 대상 <img src="../../images/common/icon_n.png" alt=""></a></td>
                                    <td>100</td>
                                    <td>2020-08-04</td>
                                    <td>홍길동</td>
				...
				<div id="regist">
                    ...
                    <a href="site1001_write.jsp" class="btn-large-red btn-write">등록</a>
				</div>
                <!-- // 페이징 -->
