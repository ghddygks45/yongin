...
<title>재능기부 신청하기 &gt; 재능기부 &gt; 휴먼 네트워크 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(1, 4);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>휴먼 네트워크</span>
                <span>재능기부</span>
				<strong>재능기부 신청하기</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>재능기부 신청하기</h2></div>
					<!-- SNS -->
                    ...
                    <div class="top-info">
                        <div class="top-info-txt bg-info-hmm0103">
                            ...
                            <p>
                                ...
                                <strong class="ft400 color-orange">평생교육 재능기부자의 개인정보가 보호</strong>되며 승인진행과정은 <strong class="ft400">[마이페이지 &gt; 재능기부 신청현황]</strong>에서 확인하실 수 있습니다.
                            </p>
                        </div>
                    </div>
...
○ 기타사항(특기사항, 수상경력 등 자율입력)
                    ...
                    <div class="layer-popup-box" data-popup="edu-popup">
                        <div class="popup pop-size-700" tabindex="0">
                            <div class="top">
                                <h4>평생교육 재능기부 신청완료</h4>
                            </div>
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-edu-pop">
                                        <p><strong class="edu-str color-black-222">평생교육 재능기부 신청이 완료되었습니다.</strong></p>
                                        <p>
                                ...
                                <div class="mypg-edu-link">
                                    <div class="inr">
                                        ...
                                        <div class="bt">
                                            <a href="../student_mypage/mypage04.jsp" class="btn small sz-free bg-lime">재능기부 신청현황</a>
                                            <a href="hmm_network0103.jsp" class="btn small sz-free bg-blue">확인</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="btn-box">
                        <div class="r">
                            <a href="#n" class="btn default sz-free bg-lime" data-focus-btn="focus-btn" onclick="layerPopupOpen('edu-popup');return false;">재능기부 신청하기</a>
                        </div>
                    </div>
