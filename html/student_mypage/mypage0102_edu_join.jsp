...
<title>교육참여내역 &gt; 상시교육 강좌관리 &gt; 나의 강좌관리 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(1, 2);
		...
		<div id="content">
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="mypage0102.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
                            <a href="mypage0102_sat.jsp" class="btn default sz-free bg-blue">만족도 조사</a>
