...
<title>상세내용 &gt; 평생교육사 현황 &gt; 평생교육사 &gt; 휴먼 네트워크 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(2, 3);
			...
			<div class="cnt-box">
				...
				<div class="cnt">
                    ...
                    <div class="section">
                        ...
                        <div class="table-box">
                            <table class="table">
                                <caption>평생교육사 주요경력 및 활동 정보를 제공하고 있는 표이며 기간, 활동명, 주관기관 순으로 나열하고 있습니다.</caption>
                                <colgroup>
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="hmm_network0203.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                    </div>
