		...
		<div class="w_popup">
            <div class="mgb20">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="common1">
                    ...
                    <tbody>
                        <tr>
                            <th>합격자 구분<strong style="font-weight:300;color: #ff0000;">(*)</strong></th>
                            <td>
                                <span class="mgr20">
                                    <input type="radio" name="pass" id="pass-y">
                                    <label for="pass-y">합격자</label>
                                </span>
                                <span class="mgr20">
                                    <input type="radio" name="pass" id="pass-n">
                                    <label for="pass-n">정원 외 인원</label>
                                </span>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="btn_wrap">
                <div class="fr">
                    <a href="#n" class="btn-large-red">합격자 강제 등록</a>
                    <a href="#n" class="btn-large-red">합격자 정보 수정</a>
