...
<title>글 등록 &gt; 나의 심리상담 &gt; 마이페이지 | 용인시평생학습관</title>
<script>
	$(function(){
		// 서브페이지 LNB 현재 메뉴 활성화
		currentPage(5);
	...
	<div class="inner">
		...
		<div id="content">
			<div class="location">
                ...
                <span>마이페이지</span>
				<strong>나의 심리상담</strong>
			</div>
			<div class="cnt-box">
				<div class="cnt-top">
					<div class="cnt-tit"><h2>나의 심리상담</h2></div>
					<!-- SNS -->
				...
				<div class="cnt">
                            ...
                            <div class="pop-content">
                                <div class="top-info">
                                    <div class="top-info-txt bg-qna">
                                        <p><strong class="color-black-222 edu-str">‘심리상담(사이버상담)’의 상담요청 내용이 수정되었습니다.</strong></p>
                                        <p>
                                ...
                                <div class="btn-box bottom-pst">
                                    <div class="r">
                                        <a href="mypage03.jsp" class="btn default sz-free bg-blue">확인</a>
                                    </div>
                                </div>
                    ...
                    <div class="btn-box">
                        <div class="l">
                            <a href="mypage03.jsp" class="btn default sz-free bg-gray">목록</a>
                        </div>
                        <div class="r">
