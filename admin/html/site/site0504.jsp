						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="common2">
							...
							<tbody>
								<tr>
                                    ...
                                    <td><a href="#n" class="board-btn green" onclick="window.open('site0504_popup02.jsp','','width=600, height=700, srcollbars=yes');return false;">결제처리</a></td>
                                    <td>-</td>
                                    <td>45,000원</td>
                                    <td>2020-06-15 13:06</td>
                                    <td>-</td>
                                    <td><a href="#n" class="board-btn blue" onclick="window.open('site0504_popup01.jsp','','width=600, height=350, srcollbars=yes');return false;">환불요청</a></td>
                                </tr>
                                <tr>
                                    <td>1</td>
                                    <td>45기</td>
